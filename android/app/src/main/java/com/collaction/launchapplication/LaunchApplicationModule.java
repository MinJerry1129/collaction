package com.collaction.collactionapp.launchapplication;
...
public class LaunchApplicationModule extends ReactContextBaseJavaModule {
  ...
  //  Intent dialogIntent = new Intent(getReactApplicationContext(), MainActivity.class);
    Intent dialogIntent = getReactApplicationContext().getPackageManager().getLaunchIntentForPackage("io.collaction.socialnetwork.rn.android");
