...
const SmsAuthenticationScreen = (props) => {
  ...
  const { isResetPassword } = props.route.params;
  useEffect(() => {
  ...
  const onSendPasswordResetEmail = () => {
    ...
    if (isValidEmail) {
      ...
      Alert.alert(
        ...
        IMLocalized('email entered is invalid '),
        [{ text: IMLocalized('OK') }],
        { cancelable: false },
      );
    }
    ...
    return (
      <>
        ...
        <Button
          ...
          <Text style={styles.textLinkStyle}>{IMLocalized('Sign up with E-mail')}</Text>
        </Button>
      </>
    );
  };
    ...
    return (
      <>
        ...
        <Button
          ...
          <Text style={styles.textLinkStyle}>{IMLocalized('Sign in with E-mail')}</Text>
        </Button>
      </>
    );
  };
